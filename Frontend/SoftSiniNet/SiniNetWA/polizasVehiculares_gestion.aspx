<%@ Page Title="" Language="C#" MasterPageFile="~/SiniNet.Master" AutoEventWireup="true" CodeBehind="polizasVehiculares_gestion.aspx.cs" Inherits="SiniNetWA.polizasVehiculares_gestion" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphTitulo" runat="server">
    Gestión de Polizas Vehiculares
</asp:Content>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                    <asp:DropDownList ID="ddlTipo" runat="server" CssClass="form-select">
                        <asp:ListItem Text="-- Seleccione --" Value="" Selected="True"></asp:ListItem>
                        <asp:ListItem Text="Todo riesgo" Value="TODORIESGO"></asp:ListItem>
                        <asp:ListItem Text="Perdida total" Value="PERDIDATOTAL"></asp:ListItem>
                        <asp:ListItem Text="Responsabilidad Civil" Value="RESPONSABILIDADCIVIL"></asp:ListItem>
                    </asp:DropDownList>
                </div>
            </div>

            <div class="mb-3 row">
                <asp:Label ID="lblPorcentaje" runat="server" Text="Porcentaje de Cobertura: " CssClass="col-sm-4 col-form-label"></asp:Label>
                <div class="col-sm-4">
                    <asp:TextBox ID="txtPorcentaje" TextMode="Number" Enabled="true" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
            </div>
