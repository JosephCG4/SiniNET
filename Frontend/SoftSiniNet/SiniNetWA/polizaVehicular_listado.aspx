<%@ Page Title="" Language="C#" MasterPageFile="~/SiniNet.Master" AutoEventWireup="true" CodeBehind="polizaVehicular_listado.aspx.cs" Inherits="SiniNetWA.polizaVehicular_listado" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphTitulo" runat="server">
    Mantenimiento de Polizas Vehiculares
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    <div class="container">
        <h2>Mantenimiento de Polizas Vehiculares</h2>
        ...
        <div class="container row">
            <asp:GridView ID="dgvPolizasVehiculares" runat="server" AllowPaging="false" AutoGenerateColumns="false" CssClass="table table-hover table-responsive table-striped">
                <Columns>
                    <asp:BoundField HeaderText="Id" DataField="polizaId" />
                    <asp:BoundField HeaderText="Estado" DataField="estado" />
                    <asp:BoundField HeaderText="Tipo" DataField="tipo" />
                    <asp:BoundField HeaderText="Procentaje Cobertura" DataField="porcentajeCobertura" />
