<%@ Page Title="" Language="C#" MasterPageFile="~/SiniNet.Master" AutoEventWireup="true" CodeBehind="talleresAdmin_gestion.aspx.cs" Inherits="SiniNetWA.talleresAdmin_gestion" %>
                            ...
                            <div class="container row pb-3 pt-3">
                                ...
                                <div class="mb-3 row">
                                    <div class="col-sm-8">
                                        ...
                                        <br />
                                        <div class="mb-3 row">
                                            <asp:Label ID="Label1" runat="server" Text="Latitud: " CssClass="col-sm-4 col-form-label"></asp:Label>
                                            <div class="col-sm-4">
                                                <asp:TextBox ID="txtLatitud" runat="server" CssClass="form-control" Enabled="false" ClientIDMode="Static"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <asp:Label ID="Label2" runat="server" Text="Longitud: " CssClass="col-sm-4 col-form-label"></asp:Label>
                                            <div class="col-sm-4">
