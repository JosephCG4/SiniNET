<%@ Page Title="" Language="C#" MasterPageFile="~/SiniNet.Master" AutoEventWireup="true" CodeBehind="centrosSaludAdmin_listado.aspx.cs" Inherits="SiniNetWA.centrosSaludAdmin_listado" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphTitulo" runat="server">
    Mantenimiento de Centros de Salud
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContenido" runat="server">
    <div class="container">
        <h2>Mantenimiento de Centros de Salud</h2>
        ...
        <div class="container row">
            <asp:GridView ID="dgvCentroSalud" runat="server" AllowPaging="false" AutoGenerateColumns="false" CssClass="table table-hover table-responsive table-striped">
                <Columns>
                    <asp:BoundField HeaderText="Id" DataField="centroDeSaludId" />
                    <asp:BoundField HeaderText="Código Renipress" DataField="codigoRenipress" />
                    <asp:BoundField HeaderText="Nombre" DataField="nombre" />
                    <asp:TemplateField HeaderText="Ubicación">
                        <ItemTemplate>
                            <asp:LinkButton ID="lbVerUbicacion" runat="server" Text="<i class='fa-solid fa-eye'></i>" CommandArgument='<%# Eval("centroDeSaludId") %>' OnClick="lbVerUbicacion_Click"></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="lbModificar" runat="server" CssClass="btn btn-sm btn-primary me-1" ToolTip="Modificar" CommandArgument='<%# Eval("centroDeSaludId") %>' OnClick="lbModificar_Click"><i class='fa-solid fa-edit'></i></asp:LinkButton>
                            <asp:LinkButton ID="lbEliminar" runat="server" CssClass="btn btn-sm btn-danger" ToolTip="Eliminar" CommandArgument='<%# Eval("centroDeSaludId") %>' OnClick="lbEliminar_Click" OnClientClick="return confirm('¿Está seguro de que desea eliminar este registro?');"><i class='fa-solid fa-trash'></i></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
